...
---
import GatsbyImage from "@stubs/GatsbyImage.astro";
import Gallery from "@stubs/Gallery.astro";
...
platform as a data source as I wanted to be able to let readers truly get involved and be able to <a href="https://github.com">submit a PR</a>
