...
Instead of showing the final demo again, I will highlight ways in which you can customise your buttons.
<Link to="/blog/2022/03/how-to-make-a-button/">Click here</Link> to go to the first post if you want the complete code.
...
or leave it whole (as that is how I would consume it) article. I found writing this post super helpful as I ended up
