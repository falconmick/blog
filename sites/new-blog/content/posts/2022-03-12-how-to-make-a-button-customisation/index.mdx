...
import StepThreeDemo from './StepThreeDemo.astro';
...
Instead of showing the final demo again, I will highlight ways in which you can customise your buttons. <a href="/blog/2022/03/how-to-make-a-button-intro/">Click
here</a> to go to the first post if you want the complete code.
