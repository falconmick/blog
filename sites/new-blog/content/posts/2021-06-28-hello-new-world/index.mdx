...
import { Gallery } from "@stubs/stubs/post/2021-06-28-hello-new-world/gallery";
...
platform as a data source as I wanted to be able to let readers truly get involved and be able to <a href={props?.githubEditPath ?? "https://github.com"}>submit a PR</a>
