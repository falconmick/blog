...
import StepOneDemo from './StepOneDemo.astro';
...
At a later point, we will go into more detail on <a href="/blog/2022/03/how-to-make-a-button-customisation/">button customisation</a>
, but the above is a quick glimpse into the tremendous power they can provide.

Next Up: <a href="/blog/2022/03/how-to-make-a-button-styling/">part 3 - styling</a>
