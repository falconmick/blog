...
const FinalComponent = () => (
  <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-around', margin: '-8px -8px 0', padding: '16px 0' }}>
    ...
    <a style={{ margin: '8px 8px 0' }} href="?click" onClick={(e) => e.preventDefault()} className="anchor-btn btn">&lt;a /&gt;</a>
    <a style={{ margin: '8px 8px 0' }} href="?click" onClick={(e) => e.preventDefault()} className="anchor-btn btn btn-green">&lt;a class="anchor-btn btn btn-green" /&gt;</a>
    <a style={{ margin: '8px 8px 0', '--btn-background-color': '#ff0021' }} href="?click" onClick={(e) => e.preventDefault()}  className="anchor-btn btn">&lt;a style="--btn-background-color: #ff0021" /&gt;</a>
  </div>
);
